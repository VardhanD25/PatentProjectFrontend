            ...
            <div className="relative">
              ...
              <div className="relative bg-slate-900/50 backdrop-blur-xl rounded-2xl border border-slate-700/50 p-8">
                ...
                <form className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-slate-300">Single Piece or Lot</label>
                    <select
                      value={pieceOrLot}
                  ...
                  {/* Density Type Field */}
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-slate-300">Calculated Density or Specified Density</label>
                    <select
                      value={density}
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-slate-300">Does the part have attachments?</label>
                    <select
                      value={attachment}
                  ...
                  {/* Master Exists Field */}
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-slate-300">Does the master sample exist?</label>
                    <select
                      value={master}
